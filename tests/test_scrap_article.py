...
import unittest
from scrapping import scrap_article

class Test_scrap_article(unittest.TestCase):
    def test_scrap_article0(self):
        res = scrap_article("https://www.abcbourse.com/marches/air-liquide-nouveaux-ppa-avec-sasol-en-afrique-du-sud_613216")
        self.assertEqual(res["title"], "Air Liquide: nouveaux PPA avec Sasol en Afrique du Sud")
    
    def test_scrap_article1(self):
        res = scrap_article("https://www.abcbourse.com/marches/air-liquide-nouveaux-ppa-avec-sasol-en-afrique-du-sud_613216")
        self.assertEqual(res["date"], "2023-11-21 09:23:00")
        
    def test_scrap_article2(self):
        res = scrap_article("https://www.abcbourse.com/marches/air-liquide-nouveaux-ppa-avec-sasol-en-afrique-du-sud_613216")
